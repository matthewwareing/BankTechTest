...
class TransactionGenerator
  ...
  def initialize(opts = {})
    ...
    # separate create into two methods, deposit and withdrawal
    # therefore removing need for new_balance method

  def create
    { transaction_date: Time.now, transaction_amount: @transaction_amount, 
...
# It's responsibility is to hold the transaction details 
